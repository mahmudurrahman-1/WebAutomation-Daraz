...
public class CommonMethods {
    ...
    public void selectitembyno(WebElement element, int value) {
        Select selectItems = new Select(element);
        selectItems.selectByIndex(value);
    }
    ...
    /***********************
     * dragslider Item left to right
     */
    public void sliderMove(WebElement el) {
        Actions act = new Actions(PageDriver.getCurrentDriver());
        act.dragAndDropBy(el, 340, 0).perform();
    }
